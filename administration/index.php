...
if (db_exists(DB_FIGURE_ITEMS)) {
	$figurelib['figure'] = dbcount("('figure_id')", DB_FIGURE_ITEMS);
	$figurelib['comment'] = dbcount("('comment_id')", DB_COMMENTS, "comment_type='FI'");
	$figurelib['submit'] = dbcount("(submit_id)", DB_SUBMISSIONS, "submit_type='f'");
}
$comments_type = array(
    'N' => $locale['269'],
    'D' => $locale['268'],
