...
if (iMEMBER) {
	...
	$result = dbquery(
			...
			".(multilang_table("FI") ? "WHERE figure_language='".LANGUAGE."' AND" : "WHERE")." tb.figure_freigabe='1' ORDER BY figure_clickcount DESC LIMIT 0,20");	
	
		
		// PANEL ÖFFNEN / ANFANG		
 
 opentable($locale['CLFP_022']);
	...
	if (iADMIN || iSUPERADMIN) {		
				...
				echo "<div class='row'>\n";
						...
						// ['CLFP_021']= "Last entries";							
						echo "<div class='col-lg-3 col-md-6 col-sm-6 col-xs-6'>\n";
							echo "<div align='center' class='text-smaller text-uppercase'><a href='".BASEDIR."home.php'>".$locale['CLFP_021']."</a></div>\n";
						echo "</div>\n";
