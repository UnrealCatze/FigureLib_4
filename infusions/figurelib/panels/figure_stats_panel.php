				...
				if (dbcount("(figure_images_image_id)", DB_FIGURE_IMAGES, "figure_images_figure_id='".$data['figure_id']."'")) {
					...
					$imageURL = INFUSIONS."figurelib/images/default.png";
						...
						if ($data['figure_pubdate'] == "") {
								...
								echo "<div class='col-lg-2 col-md-4 hidden-sm hidden-xs text-danger'><div class='side-small' title='".$locale['CLFP_006']." : ".$locale['CLFP_008']."' alt='".$locale['CLFP_006']." : ".$locale['CLFP_008']."'>".trimlink($locale['CLFP_008'],15)."</div></div>\n";
								} else {
								echo "<div class='col-lg-2 col-md-4 hidden-sm hidden-xs text-danger'><div class='side-small' title='".$locale['CLFP_006']." : ".$data['figure_pubdate']."' alt='".$locale['CLFP_006']." : ".$data['figure_pubdate']."'>".trimlink($data['figure_pubdate'],15)."</div></div>\n";
								} 								
