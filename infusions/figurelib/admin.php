...
// TAB MENÜ OBERPUNKTE
		...
		// $locale['filt_0020'] = "Figure Inactive";
		$inactiveCounter = dbcount("(figure_id)", DB_FIGURE_ITEMS, "figure_freigabe='3'");
		$master_title['title'][] = $locale['filt_0020']."  <span class='badge'>".$inactiveCounter."</span>"; 
		$master_title['id'][] = 'figurelib_inactive';
		$master_title['icon'] = '';
...
switch ($_GET['section']) {
	...
	case "figurelib_pendings":
		...
		break;
	case "figurelib_inactive":
		add_breadcrumb(array('link'=>"", 'title'=>$locale['filt_0020'])); // $locale['filt_0020'] = Inactive
		include "admin/admin_figurelib_inactive.php";
		break;
	default:
		figurelib_listing();
}
