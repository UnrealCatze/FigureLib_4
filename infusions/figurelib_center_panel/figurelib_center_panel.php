...
if (dbrows($result) != 0) {
	...
	while($data = dbarray($result)) {		
		...
		if ($data['figure_pubdate'] == "") {
			echo "<div class='col-lg-1 col-md-2 hidden-sm hidden-xs'><div class='side-small figurelib-inforow-height' title='".$locale['CLFP_006']." : ".$locale['CLFP_008']."' alt='".$locale['CLFP_006']." : ".$locale['CLFP_008']."'>".trimlink($locale['CLFP_008'],5)."</div></div>\n";
		} else {
		...
		echo "<div class='col-lg-1 col-md-1 col-sm-1 col-xs-1'>\n";
			echo "<div class='figurelib-inforow-height'>\n";
				...
				echo "<div class='fa fa-eye-slash' data-toggle='tooltip' data-placement='fa fa-eye-slash' title='".$locale['mc_0011']."'></div>";
				}
			echo "</div>\n";
		echo "</div>\n";
